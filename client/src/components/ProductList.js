 ...
 let hidePopUp = (id) => {
  ...
  return (
    <div className="container">
                <EditPopUp show={show} handleClose={hidePopUp} productId={productId} />
        ...
        {user.Products ? (
          user.Products.map((item) => (
            <li className="list-group-item">
              ...
              <span className="ml-1">
                Edit<i className="fa fa-edit ml-2 mr-1 cursor" aria-hidden="true" onClick={id => showPopUp(item.id)}></i>|         
              </span>
              <span className="ml-1">
